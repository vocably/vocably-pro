...
(self.webpackChunkextension_popup =
  ...
  [862],
  {
    862: (t, a, i) => {
      ...
      const o = class {
        constructor(t) {
          (0, e.r)(this, t), (this.close = (0, e.c)(this, 'close', 7));
        }
        render() {
          return (0, e.h)(
            e.H,
      ...
      const r = {
        ...
        s = class {
          constructor(t) {
            (0, e.r)(this, t), (this.confirm = (0, e.c)(this, 'confirm', 7));
          }
          render() {
            return (0, e.h)(
              e.H,
      ...
      const h = class {
        ...
        componentDidRender() {
          const t = this.el.shadowRoot.getElementById('content-wrapper'),
            a = this.el.shadowRoot.getElementById('content');
          new ResizeObserver(() => {
          ...
          const t =
              ...
              (0, e.h)(
                ...
                Object.entries(r)
                  .sort(
                    ((t) => (a, i) => {
                      const e = t.includes(a[0]),
                        n = t.includes(i[0]);
                      return e && !n
                        ? -1
                        : !e && n
                        ? 1
                        : a[1].localeCompare(i[1]);
                    })(this.existingLanguages)
                  )
                  .map(([t, a]) =>
                    (0, e.h)(
            ...
            a =
              ...
              ((t) => {
                ...
                const a = t.cards[0].data;
                return !(
                  t.source === a.source &&
                  t.translation.target === a.translation
                );
              })(this.result.value);
          return (0, e.h)(
            e.H,
                  ...
                  (0, e.h)(
                    ...
                    a &&
                      (0, e.h)(
                        'div',
                        { class: 'section' },
                        (0, e.h)('div', { class: 'margin-bottom-1' }, t),
                        (0, e.h)(
                          'div',
                    ...
                    (0, e.h)(
                      'div',
                      { class: 'section' },
                      !a && (0, e.h)('div', { class: 'margin-bottom-2' }, t),
                      (0, e.h)(
                        'div',
                        { class: 'cards', 'data-test': 'cards' },
                        this.result.value.cards.map((t, a, i) =>
                          (0, e.h)(
                            'div',
                            {
                              'data-test': 'card',
