...
(self.webpackChunkextension_popup =
  self.webpackChunkextension_popup || []).push([
  [736],
  {
    736: (a, t, i) => {
      i.r(t),
        i.d(t, {
          vocably_button: () => n,
          vocably_close_button: () => o,
          vocably_google_button: () => s,
          vocably_google_icon: () => r,
          vocably_language: () => d,
          vocably_logo: () => h,
          vocably_popup: () => c,
          vocably_side_b: () => p,
      ...
      const o = class {
        constructor(a) {
          (0, e.r)(this, a), (this.close = (0, e.c)(this, 'close', 7));
        }
        render() {
          return (0, e.h)(
            e.H,
            ...
            (0, e.h)(
              ...
              (0, e.h)(
                ...
                (0, e.h)('path', { class: 'path', d: 'M10 0L0 10M0 0L10 10' })
              )
            )
          );
        }
        ...
        render() {
          return (0, e.h)(
            ...
            (0, e.h)(
              ...
              (0, e.h)('vocably-google-icon', { class: 'icon' })
            ),
            (0, e.h)('div', { class: 'label' }, (0, e.h)('slot', null))
          );
        }
      };
      s.style =
        ':host{--color:#4285f4;--border-radius:2px;--shadow-spread:3px;--shadow-blur:2px;display:inline-block;padding:calc(var(--shadow-spread) + var(--shadow-blur))}.button{background:var(--color);color:#fff;border:1px solid var(--color);border-radius:var(--border-radius);padding:0;font:inherit;cursor:pointer;display:inline-flex;align-items:center;outline:none}.button:focus,.button:hover{box-shadow:0 0 var(--shadow-spread) var(--shadow-blur) rgba(66, 133, 244, 0.6)}.button:active{--color:#3367d6;box-shadow:0 0 var(--shadow-spread) calc(var(--shadow-blur) - 2px) rgba(66, 133, 244, 0.6)}.button .icon-container{background:#fff;padding:15px;border-radius:var(--border-radius)}.button .icon{width:18px;height:18px;display:block}.button .label{padding:0 24px;font-weight:500;font-size:16px}';
      const r = class {
        constructor(a) {
          (0, e.r)(this, a);
        }
        render() {
          return (0, e.h)(
            'svg',
            {
              'enable-background': 'new 0 0 533.5 544.3',
              version: '1.1',
      ...
      r.style =
        ':host{display:inline-block;width:20px;height:20px;line-height:20px;vertical-align:middle}';
      const l = {
          af: 'Afrikaans',
          sq: 'Albanian',
          am: 'Amharic',
        ...
        d = class {
          constructor(a) {
            (0, e.r)(this, a), (this.confirm = (0, e.c)(this, 'confirm', 7));
          }
          render() {
            return (0, e.h)(
              e.H,
              ...
              (0, e.h)(
                ...
                (0, e.h)(
                  ...
                  (0, e.h)(
                    ...
                    Object.entries(l).map(([a, t]) =>
                      (0, e.h)(
                        'option',
                        { selected: this.language === a, value: a },
                        t
                      )
                    )
                  )
      ...
      const c = class {
        ...
        componentDidRender() {
          const a = this.el.shadowRoot.getElementById('content-wrapper'),
            t = this.el.shadowRoot.getElementById('content');
          new ResizeObserver(() => {
          ...
          return (0, e.h)(
            ...
            (0, e.h)(
              ...
              (0, e.h)(
                'div',
                { class: 'header' },
                (0, e.h)('vocably-logo', { class: 'logo' }),
                (0, e.h)('vocably-close-button', { class: 'close' })
              ),
              (0, e.h)('div', { class: 'footer' })
            )
          );
        }
        get el() {
      ...
      const g = class {
        ...
        render() {
          return (0, e.h)(
            e.H,
            { 'data-test': 'sign-in' },
            (0, e.h)('div', { class: 'p' }, 'Please sign in to proceed.'),
            (0, e.h)(
              'div',
              { class: 'p' },
              (0, e.h)(
        ...
        render() {
          return (0, e.h)(
            ...
            (0, e.h)(
              'div',
              { class: 'spinner' },
              (0, e.h)('div', { class: 'bounce1' }),
              (0, e.h)('div', { class: 'bounce2' }),
              (0, e.h)('div', { class: 'bounce3' })
            )
          );
        }
      };
      ...
      const u = class {
        constructor(a) {
          (0, e.r)(this, a),
            (this.confirm = (0, e.c)(this, 'confirm', 7)),
            (this.trial = !1);
        }
        render() {
          return (0, e.h)(
      ...
      const m = class {
        constructor(a) {
          (0, e.r)(this, a),
            (this.changeLanguage = (0, e.c)(this, 'changeLanguage', 7)),
            (this.result = null),
            (this.loading = !1),
          ...
          const a =
              ...
              (0, e.h)(
                'select',
                {
                  ...
                  onChange: (a) => this.changeLanguage.emit(a.target.value),
                },
                Object.entries(l)
                  .sort(
                    ((a) => (t, i) => {
                      const e = a.includes(t[0]),
                        n = a.includes(i[0]);
                      return e && !n
                        ? -1
                        : !e && n
                        ? 1
                        : t[1].localeCompare(i[1]);
                    })(this.existingLanguages)
                  )
                  .map(([a, t]) =>
                    (0, e.h)(
            ...
            t =
              ...
              ((a) => {
                if (
                  a.translation.sourceLanguage === a.translation.targetLanguage
                )
                  return !1;
                if (a.cards.length > 1) return !0;
                const t = a.cards[0].data;
                return !(
                  a.source === t.source &&
                  a.translation.target === t.translation
                );
              })(this.result.value);
          return (0, e.h)(
            e.H,
            ...
            (0, e.h)(
              ...
              null === this.result && (0, e.h)('vocably-spinner', null),
              this.result &&
                !1 === this.result.success &&
                (0, e.h)('div', { class: 'error' }, 'An error has occurred.'),
              this.result &&
                  ...
                  (0, e.h)(
                    ...
                    t &&
                      (0, e.h)(
                        'div',
                        { class: 'section' },
                        (0, e.h)('div', { class: 'margin-bottom-1' }, a),
                        (0, e.h)(
                          'div',
                    ...
                    (0, e.h)(
                      'div',
                      { class: 'section' },
                      !t && (0, e.h)('div', { class: 'margin-bottom-2' }, a),
                      (0, e.h)(
                        'div',
                        { class: 'cards', 'data-test': 'cards' },
                        this.result.value.cards.map((a, t, i) =>
                          (0, e.h)(
                            'div',
                            {
                              'data-test': 'card',
                              class:
                                'card' + (i.length > 1 ? ' has-number' : ''),
                            },
                            i.length > 1 &&
                              (0, e.h)('div', { class: 'number' }, t + 1),
                            (0, e.h)(
                              'div',
                              null,
                              (0, e.h)('span', { class: 'small' }, 'Side'),
                              ' ',
                              (0, e.h)('span', { class: 'text-primary' }, 'A')
                            ),
                            (0, e.h)(
                              'div',
                              { class: 'margin-left' },
                            ...
                            (0, e.h)(
                              ...
                              (0, e.h)('span', { class: 'small' }, 'Side'),
                              ' ',
                              (0, e.h)('span', { class: 'text-primary' }, 'B')
                            ),
                            (0, e.h)(
                              'div',
                              { class: 'margin-left' },
                              (0, e.h)('vocably-side-b', { item: a })
                            )
                          )
                        )
                      )
